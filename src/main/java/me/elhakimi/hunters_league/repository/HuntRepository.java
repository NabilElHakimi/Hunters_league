...
import me.elhakimi.hunters_league.repository.dto.HuntDTO;
...
@Query("SELECT new me.elhakimi.hunters_league.repository.dto.HuntDTO(h.weight, s.category,s.difficulty,s.points)" +
